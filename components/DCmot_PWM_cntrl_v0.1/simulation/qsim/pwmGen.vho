...
-- Design Ports Information
-- PWM_DCmot	=>  Location: PIN_C5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- DCmot_speedv[2]	=>  Location: PIN_F7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- DCmot_speedv[1]	=>  Location: PIN_C4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- DCmot_speedv[0]	=>  Location: PIN_E8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- CLK1	=>  Location: PIN_M8,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF pwmGen IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \counter~1_combout\ = (counter(0) & ((!counter(1)))) # (!counter(0) & (!counter(2) & counter(1)))
...
-- Equation(s):
-- \counter~2_combout\ = (!counter(0) & ((!counter(1)) # (!counter(2))))
...
-- Equation(s):
-- \counter~0_combout\ = (counter(2) & ((!counter(1)))) # (!counter(2) & (counter(0) & counter(1)))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (\DCmot_speedv[1]~input_o\ & ((\DCmot_speedv[0]~input_o\) # ((counter(1)) # (counter(0))))) # (!\DCmot_speedv[1]~input_o\ & (counter(1) & ((\DCmot_speedv[0]~input_o\) # (counter(0)))))
...
-- Equation(s):
-- \LessThan0~1_combout\ = (counter(2) & (!\DCmot_speedv[2]~input_o\ & !\LessThan0~0_combout\)) # (!counter(2) & ((!\LessThan0~0_combout\) # (!\DCmot_speedv[2]~input_o\)))
