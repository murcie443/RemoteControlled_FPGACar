...
ENTITY 	PWM_DCMotor IS
	...
	PWM_DCmot_rev : BUFFER std_logic
	);
END PWM_DCMotor;
...
SIGNAL \U_rev|LessThan0~0_combout\ : std_logic;
SIGNAL \U_rev|LessThan0~1_combout\ : std_logic;
SIGNAL \U_rev|PWM_DCmot~q\ : std_logic;
...
-- Equation(s):
-- \U0|counter~2_combout\ = (!\U0|counter\(0) & ((!\U0|counter\(2)) # (!\U0|counter\(1))))
...
-- Equation(s):
-- \U0|counter~1_combout\ = (\U0|counter\(0) & (!\U0|counter\(1))) # (!\U0|counter\(0) & (\U0|counter\(1) & !\U0|counter\(2)))
...
-- Equation(s):
-- \U0|counter~0_combout\ = (\U0|counter\(1) & (!\U0|counter\(2) & \U0|counter\(0))) # (!\U0|counter\(1) & (\U0|counter\(2)))
...
-- Equation(s):
-- \U0|LessThan0~1_combout\ = (\U0|counter\(2) & (\DCmot_speedv[2]~input_o\ & \U0|LessThan0~0_combout\)) # (!\U0|counter\(2) & ((\DCmot_speedv[2]~input_o\) # (\U0|LessThan0~0_combout\)))
...
\U_rev|LessThan0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_rev|LessThan0~0_combout\ = (\DCmot_speedv[1]~input_o\ & (!\DCmot_speedv[0]~input_o\ & (!\U0|counter\(0) & !\U0|counter\(1)))) # (!\DCmot_speedv[1]~input_o\ & (((!\DCmot_speedv[0]~input_o\ & !\U0|counter\(0))) # (!\U0|counter\(1))))
...
PORT MAP (
	...
	datac => \U0|counter\(0),
	datad => \U0|counter\(1),
	combout => \U_rev|LessThan0~0_combout\);

-- Location: LCCOMB_X24_Y38_N30
\U_rev|LessThan0~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_rev|LessThan0~1_combout\ = (\U0|counter\(2) & (!\DCmot_speedv[2]~input_o\ & \U_rev|LessThan0~0_combout\)) # (!\U0|counter\(2) & ((\U_rev|LessThan0~0_combout\) # (!\DCmot_speedv[2]~input_o\)))
...
PORT MAP (
	datab => \U0|counter\(2),
	datac => \DCmot_speedv[2]~input_o\,
	datad => \U_rev|LessThan0~0_combout\,
	combout => \U_rev|LessThan0~1_combout\);

-- Location: FF_X24_Y38_N31
\U_rev|PWM_DCmot\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \PWM_DCmot_rev~0_combout\ = (\U_rev|PWM_DCmot~q\ & !\dir_mot~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \U_rev|PWM_DCmot~q\,
	datad => \dir_mot~input_o\,
