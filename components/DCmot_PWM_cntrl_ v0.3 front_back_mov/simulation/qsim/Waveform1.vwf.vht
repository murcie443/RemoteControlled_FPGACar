...
-- *****************************************************************************
-- Generated on "05/29/2024 17:09:07"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          PWM_DCMotor
-- 
...
ENTITY PWM_DCMotor_vhd_vec_tst IS
END PWM_DCMotor_vhd_vec_tst;
ARCHITECTURE PWM_DCMotor_arch OF PWM_DCMotor_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL CLK1 : STD_LOGIC;
SIGNAL DCmot_speedv : STD_LOGIC_VECTOR(2 DOWNTO 0);
SIGNAL dir_mot : STD_LOGIC;
SIGNAL PWM_DCmot : STD_LOGIC;
SIGNAL PWM_DCmot_rev : STD_LOGIC;
COMPONENT PWM_DCMotor
	PORT (
	CLK1 : IN STD_LOGIC;
...
-- dir_mot
t_prcs_dir_mot: PROCESS
BEGIN
	dir_mot <= '1';
WAIT;
END PROCESS t_prcs_dir_mot;
END PWM_DCMotor_arch;
