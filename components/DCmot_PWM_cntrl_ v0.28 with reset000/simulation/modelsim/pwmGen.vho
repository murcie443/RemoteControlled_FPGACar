...
-- Design Ports Information
-- PWM_DCmot	=>  Location: PIN_D8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- DCmot_speedv[0]	=>  Location: PIN_A5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- DCmot_speedv[1]	=>  Location: PIN_A4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- DCmot_speedv[2]	=>  Location: PIN_D10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \innercounter[2]~0_combout\ : std_logic;
...
SIGNAL \innercounter[2]~3_combout\ : std_logic;
...
-- Equation(s):
-- \flag~0_combout\ = (!\Add2~0_combout\ & !\Equal2~10_combout\)
...
-- Equation(s):
-- \Add0~26_combout\ = counter(13) $ (\Add0~25\)
...
-- Equation(s):
-- \counter~0_combout\ = (\Add0~26_combout\ & !\Equal0~4_combout\)
...
-- Equation(s):
-- \counter~1_combout\ = (\Add0~8_combout\ & !\Equal0~4_combout\)
...
\counter[5]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \counter[5]~feeder_combout\ = \Add0~10_combout\
...
-- Equation(s):
-- \counter~2_combout\ = (\Add0~16_combout\ & !\Equal0~4_combout\)
...
-- Equation(s):
-- \counter~3_combout\ = (!\Equal0~4_combout\ & \Add0~18_combout\)
...
-- Equation(s):
-- \Equal0~3_combout\ = (!counter(11) & (counter(8) & (counter(9) & !counter(12))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (counter(1) & (counter(2) & counter(0)))
...
-- Equation(s):
-- \Equal0~4_combout\ = (counter(13) & (\Equal0~3_combout\ & (counter(10) & \Equal0~2_combout\)))
...
-- Equation(s):
-- \counter~4_combout\ = (!\Equal0~4_combout\ & \Add0~20_combout\)
...
-- Equation(s):
-- \LessThan0~0_combout\ = (!counter(11) & (!counter(13) & !counter(12)))
...
\innercounter[2]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \innercounter[2]~0_combout\ = (\LessThan0~0_combout\ & ((\DCmot_speedv[1]~input_o\) # ((\DCmot_speedv[2]~input_o\) # (\DCmot_speedv[0]~input_o\))))
...
PORT MAP (
	...
	combout => \innercounter[2]~0_combout\);

-- Location: LCCOMB_X31_Y35_N22
\LessThan1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \LessThan1~0_combout\ = (!counter(8) & (!counter(10) & (!counter(9) & \Equal0~0_combout\)))
...
-- Equation(s):
-- \LessThan1~1_combout\ = (\LessThan1~0_combout\ & (((!counter(1)) # (!counter(2))) # (!counter(3))))
...
-- Equation(s):
-- \LessThan0~1_combout\ = (!counter(3) & (!\Equal0~1_combout\ & \LessThan1~0_combout\))
...
-- Equation(s):
-- \innercounter[2]~1_combout\ = (\innercounter[2]~0_combout\ & (\LessThan1~1_combout\ & ((!\LessThan0~1_combout\) # (!\LessThan0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \innercounter[2]~0_combout\,
...
-- Equation(s):
-- \Equal2~1_combout\ = (!flag(5) & (!flag(4) & (!flag(7) & !flag(6))))
...
-- Equation(s):
-- \Equal2~2_combout\ = (!flag(8) & (!flag(9) & (!flag(10) & !flag(11))))
...
-- Equation(s):
-- \Equal2~3_combout\ = (!flag(13) & (!flag(14) & (!flag(15) & !flag(12))))
...
-- Equation(s):
-- \Equal2~0_combout\ = (!flag(0) & (!flag(2) & (!flag(1) & !flag(3))))
...
-- Equation(s):
-- \Equal2~8_combout\ = (!flag(24) & (!flag(25) & (!flag(27) & !flag(26))))
...
-- Equation(s):
-- \Equal2~6_combout\ = (!flag(20) & !flag(21))
...
-- Equation(s):
-- \Equal2~5_combout\ = (!flag(16) & (!flag(19) & (!flag(18) & !flag(17))))
...
-- Equation(s):
-- \Equal2~7_combout\ = (!flag(23) & (!flag(22) & (\Equal2~6_combout\ & \Equal2~5_combout\)))
...
-- Equation(s):
-- \Equal2~9_combout\ = (!flag(29) & (!flag(30) & (!flag(28) & !flag(31))))
...
-- Equation(s):
-- \Equal2~10_combout\ = (\Equal2~4_combout\ & (\Equal2~8_combout\ & (\Equal2~7_combout\ & \Equal2~9_combout\)))
...
\innercounter[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \innercounter[2]~3_combout\ = (\innercounter[2]~1_combout\ & \Equal2~10_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \innercounter[2]~1_combout\,
	datad => \Equal2~10_combout\,
	combout => \innercounter[2]~3_combout\);
...
-- Equation(s):
-- \innercounter~5_combout\ = (innercounter(1) & (!innercounter(2) & innercounter(0))) # (!innercounter(1) & (innercounter(2)))
...
-- Equation(s):
-- \innercounter~4_combout\ = (innercounter(1) & (!innercounter(2) & !innercounter(0))) # (!innercounter(1) & ((innercounter(0))))
...
-- Equation(s):
-- \PWM_DCmot~1_combout\ = (innercounter(1) & (!innercounter(0) & (\DCmot_speedv[0]~input_o\ & \DCmot_speedv[1]~input_o\))) # (!innercounter(1) & ((\DCmot_speedv[1]~input_o\) # ((!innercounter(0) & \DCmot_speedv[0]~input_o\))))
...
-- Equation(s):
-- \PWM_DCmot~2_combout\ = (\LessThan1~1_combout\ & ((\PWM_DCmot~1_combout\ & ((\DCmot_speedv[2]~input_o\) # (!innercounter(2)))) # (!\PWM_DCmot~1_combout\ & (\DCmot_speedv[2]~input_o\ & !innercounter(2)))))
...
-- Equation(s):
-- \PWM_DCmot~0_combout\ = (\LessThan0~1_combout\) # ((\PWM_DCmot~reg0_q\ & (\LessThan1~1_combout\ & !\Equal2~10_combout\)))
...
-- Equation(s):
-- \PWM_DCmot~3_combout\ = (\innercounter[2]~0_combout\ & ((\PWM_DCmot~0_combout\) # ((\Equal2~10_combout\ & \PWM_DCmot~2_combout\))))
...
PORT MAP (
	...
	datab => \innercounter[2]~0_combout\,
