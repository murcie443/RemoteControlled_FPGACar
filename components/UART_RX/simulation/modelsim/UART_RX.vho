...
-- Equation(s):
-- \Equal0~2_combout\ = (!r_Clk_Count(6) & (!r_Clk_Count(10) & (r_Clk_Count(9) & r_Clk_Count(11))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (r_Clk_Count(3) & (!r_Clk_Count(2) & (!r_Clk_Count(4) & r_Clk_Count(5))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (\Equal0~2_combout\ & (!r_Clk_Count(12) & (\Equal0~1_combout\ & \Equal0~0_combout\)))
...
-- Equation(s):
-- \LessThan1~3_combout\ = (!r_Clk_Count(7) & (!r_Clk_Count(9) & (!r_Clk_Count(11) & !r_Clk_Count(8))))
...
-- Equation(s):
-- \Decoder0~0_combout\ = (!\LessThan1~2_combout\ & (r_Clk_Count(12) & (\r_SM_Main.s_RX_Data_Bits~q\ & !\LessThan1~6_combout\)))
...
-- Equation(s):
-- \Selector14~0_combout\ = (r_Bit_Index(0) & (\Decoder0~0_combout\ & (r_Bit_Index(1) $ (r_Bit_Index(2)))))
...
-- Equation(s):
-- \Selector14~1_combout\ = (\r_SM_Main.s_RX_Data_Bits~q\ & (((!r_Bit_Index(0)) # (!\LessThan1~7_combout\)))) # (!\r_SM_Main.s_RX_Data_Bits~q\ & (\r_SM_Main.s_Idle~q\))
...
-- Equation(s):
-- \Decoder0~8_combout\ = (r_Bit_Index(0) & (r_Bit_Index(1) & (r_Bit_Index(2) & \Decoder0~0_combout\)))
...
-- Equation(s):
-- \Selector0~0_combout\ = (!\r_SM_Main.s_RX_Data_Bits~q\ & !\r_SM_Main.s_RX_Stop_Bit~q\)
...
-- Equation(s):
-- \r_SM_Main~7_combout\ = (r_Clk_Count(12) & (\r_SM_Main.s_RX_Stop_Bit~q\ & (!\LessThan1~2_combout\ & !\LessThan1~6_combout\)))
...
-- Equation(s):
-- \Decoder0~5_combout\ = (r_Bit_Index(2) & (!r_Bit_Index(1) & (!r_Bit_Index(0) & \Decoder0~0_combout\)))
...
-- Equation(s):
-- \Decoder0~6_combout\ = (r_Bit_Index(2) & (!r_Bit_Index(1) & (r_Bit_Index(0) & \Decoder0~0_combout\)))
...
-- Equation(s):
-- \Decoder0~7_combout\ = (r_Bit_Index(2) & (r_Bit_Index(1) & (!r_Bit_Index(0) & \Decoder0~0_combout\)))
